...
function RestaurantDetail() {
  ...
  const [map, setMap] = useState(null); // State to store the Leaflet map object
...
//       {currentImage && (
//         <div className="lightbox" style={{ transform: `scale(${zoomLevel})` }}>
//           <span className="close" onClick={() => setCurrentImage(null)}>
//             &times;
//           </span>
//           <img src={currentImage} alt="Current Menu Item" />
...
// import axios from "axios";
// import { useNavigate, useParams } from "react-router-dom";
// import FsLightbox from "fslightbox-react"; // Import from fslightbox-react
// import "./style.css";
...
//               setLightboxOpen(!lightboxOpen); // Toggle the lightbox
//             }}
//           >
//             <img
...
// import { useNavigate, useParams } from "react-router-dom";
// import "./style.css";
// import Lightbox from "react-spring-lightbox"; // Import react-spring-lightbox
// import { confirmAlert } from "react-confirm-alert";
// import "react-confirm-alert/src/react-confirm-alert.css";
